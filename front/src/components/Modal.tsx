...
export default function BasicModalDialog({ open, setOpen }: BasicModalDialogProps) {
        ...
        <React.Fragment>
            ...
            <Modal open={open} onClose={() => setOpen(false)}>
                <ModalDialog sx={{ width: '400px' }}>
                    <DialogTitle>Criar uma nova Doação</DialogTitle>
                    <DialogContent>Preencha as informações da doação.</DialogContent>
                    <form
